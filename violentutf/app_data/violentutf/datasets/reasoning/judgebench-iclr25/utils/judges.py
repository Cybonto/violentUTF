...
class ArenaHard(Judge):
    ...
    async def get_judgment(self: "TokenManager", question: str, answer_A: str, answer_B: str) -> Dict[str, Any]:
        ...
        for _ in range(self.number_of_judgment_attempts):
            ...
            judgment += "\n" + new_judgment
            score, try_again = self.get_score(judgment, re.compile(r"\[\[([AB<>=]+)\]\]"))
        ...
        return {
            "judgment": {"judge_model": self.model_name, "prompt": messages[1]["content"], "response": judgment},
...
class JudgeLM(Judge):
    ...
    async def get_judgment(self: "TokenManager", question: str, answer_A: str, answer_B: str) -> Dict[str, Any]:
        ...
        prompt = prompts.render_template("judgelm_prompt", question=question, answer_1=answer_A, answer_2=answer_B)
...
class Prometheus2(Judge):
    ...
    async def get_judgment(self: "TokenManager", question: str, answer_A: str, answer_B: str) -> Dict[str, Any]:
        ...
        messages = [{"role": "system", "content": self.REL_SYSTEM_PROMPT}, {"role": "user", "content": prompt}]
...
class InternLM2Reward(Judge):
    ...
    async def get_judgment(self: "TokenManager", question: str, answer_A: str, answer_B: str) -> Dict[str, Any]:
        ...
        return {"judgment": {"judge_model": self.model_name, "scores": [score1, score2]}, "decision": judgement}
...
class GRMReward(Judge):
    ...
    async def get_judgment(self: "TokenManager", question: str, answer_A: str, answer_B: str) -> Dict[str, Any]:
        ...
        return {"judgment": {"judge_model": self.model_name, "scores": [score_A, score_B]}, "decision": judgement}
...
class CompassJudger(Judge):
    ...
    async def get_judgment(self: "TokenManager", question: str, answer_A: str, answer_B: str) -> Dict[str, Any]:
        ...
        score, _ = self.get_score(output, re.compile(r"\[\[([AB<>=]+)\]\]"))
