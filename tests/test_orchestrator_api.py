...
def test_list_orchestrator_types(mock_auth):
    ...
    with patch('violentutf_api.fastapi_app.app.services.pyrit_orchestrator_service.pyrit_orchestrator_service.get_orchestrator_types') as mock_get_types:
...
def test_create_orchestrator_configuration(mock_auth, mock_db):
    ...
    with patch('violentutf_api.fastapi_app.app.services.pyrit_orchestrator_service.pyrit_orchestrator_service.create_orchestrator_instance') as mock_create:
...
def test_execute_orchestrator(mock_auth, mock_db):
    ...
    with patch('violentutf_api.fastapi_app.app.services.pyrit_orchestrator_service.pyrit_orchestrator_service.execute_orchestrator') as mock_execute:
...
def test_get_orchestrator_memory(mock_auth, mock_db):
    ...
    with patch('violentutf_api.fastapi_app.app.services.pyrit_orchestrator_service.pyrit_orchestrator_service.get_orchestrator_memory') as mock_get_memory:
...
def test_get_orchestrator_scores(mock_auth, mock_db):
    ...
    with patch('violentutf_api.fastapi_app.app.services.pyrit_orchestrator_service.pyrit_orchestrator_service.get_orchestrator_scores') as mock_get_scores:
        mock_get_scores.return_value = [
            {"id": "1", "score_value": 0.8, "score_type": "test"}
        ]
...
def test_delete_orchestrator_configuration(mock_auth, mock_db):
    ...
    with patch('violentutf_api.fastapi_app.app.services.pyrit_orchestrator_service.pyrit_orchestrator_service.dispose_orchestrator') as mock_dispose:
