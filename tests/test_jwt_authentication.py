...
class TestStreamlitIntegration:
    ...
    def test_sidebar_status_messages(self):
        ...
        status_tests = [
            ...
            {"status": "expiring_soon", "minutes": 5, "expected": "⚠️ AI Gateway: Expires in 5m"},
            {"status": "active", "minutes": 45, "expected": "🚀 AI Gateway: Active (45m left)"},
        ]
...
class TestFastAPIIntegration:
    ...
    def test_error_handling_for_missing_api_key(self):
        ...
        mock_request_with_key = {
            "headers": {"Content-Type": "application/json", "X-API-Gateway": "APISIX", "apikey": "test_api_key"}
        }
