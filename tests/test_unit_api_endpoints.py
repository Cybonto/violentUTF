...
class TestDatabaseEndpoints:
    ...
    def test_initialize_database(
        self, mock_exists, mock_duckdb, mock_makedirs, auth_headers
    ):
    ...
    def test_get_database_status(
        self, mock_duckdb, mock_stat, mock_exists, auth_headers
    ):
...
class TestSessionEndpoints:
    ...
    def test_update_session_state(
        self, mock_makedirs, mock_exists, mock_file, auth_headers
    ):
...
class TestConfigEndpoints:
    ...
    def test_get_config_parameters(
        self, mock_getmtime, mock_exists, mock_file, auth_headers
    ):
