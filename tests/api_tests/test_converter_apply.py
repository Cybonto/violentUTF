...
class TestConverterApply:
    ...
    def test_converter_apply_copy_mode(self):
        ...
        print(f"✅ COPY mode successfully created new dataset '{new_dataset_name}' with {result['converted_count']} converted prompts")
    ...
    def test_converter_apply_overwrite_mode(self):
        ...
        print(f"✅ OVERWRITE mode successfully updated dataset '{original_name}' with {result['converted_count']} converted prompts")
