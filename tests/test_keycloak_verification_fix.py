...
def test_keycloak_verification_implementation():
    ...
    try:
        with open("/Users/tamnguyen/Documents/GitHub/ViolentUTF_nightly/violentutf_api/fastapi_app/app/services/keycloak_verification.py", "r") as f:
            content = f.read()
    ...
    try:
        with open("/Users/tamnguyen/Documents/GitHub/ViolentUTF_nightly/violentutf_api/fastapi_app/app/api/endpoints/auth.py", "r") as f:
            auth_content = f.read()
    ...
    valid_payload = {
        ...
        "name": "Test User",
        "realm_access": {
            "roles": ["user", "ai-access"]
        },
        "resource_access": {
            "violentutf-api": {
                "roles": ["violentutf-user"]
            }
        },
