...
class TestCommandProcessingIntegration:
    ...
    async def test_enhancement_command_with_mcp(self, mock_client_class) -> None:
        ...
        result = await client.get_prompt("enhance_prompt", {"prompt": "Write a Python function"})
    ...
    def test_command_autocomplete(self) -> None:
        ...
        for partial, expected_contains in test_cases:
            ...
            assert any(exp in suggestion for suggestion in suggestions for exp in expected_contains)
