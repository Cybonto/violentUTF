...
def test_endpoint(method: str, endpoint: str, description: str, payload: Optional[Dict] = None, 
                 expected_status: Optional[int] = None, skip_reason: Optional[str] = None) -> bool:
...
def test_auth_endpoints():
    ...
    test_endpoint("POST", "/api/v1/auth/token/validate", "Validate token", 
    ...
    test_endpoint("POST", "/api/v1/auth/token", "Login endpoint", 
...
def test_jwt_key_endpoints():
    ...
    # Test key creation
    key_created = test_endpoint("POST", "/api/v1/keys/create", "Create API key",
    ...
    if key_created:
        ...
        test_endpoint("DELETE", "/api/v1/keys/test_key_id", "Delete API key",
...
def test_database_endpoints():
    ...
    test_endpoint("POST", "/api/v1/database/initialize", "Initialize database", 
    ...
    test_endpoint("POST", "/api/v1/database/reset", "Reset database",
...
def test_session_endpoints():
    ...
    # Test session update
    test_endpoint("PUT", "/api/v1/sessions", "Update session state",
                 {
    ...
    test_endpoint("POST", "/api/v1/sessions/reset", "Reset session",
...
def test_config_endpoints():
    ...
    test_endpoint("PUT", "/api/v1/config/parameters", "Update parameters",
                 {"parameters": {"test_param": "test_value"}, "merge_strategy": "merge"})
    
    # Test environment validation
    test_endpoint("POST", "/api/v1/config/environment/validate", "Validate environment",
    ...
    test_endpoint("POST", "/api/v1/config/parameters/load", "Load config from file",
                 skip_reason="Requires file upload")
    test_endpoint("PUT", "/api/v1/config/environment", "Update environment",
...
def test_file_endpoints():
    ...
    test_endpoint("POST", "/api/v1/files/upload", "Upload file",
                 skip_reason="Requires multipart file upload")
    test_endpoint("GET", "/api/v1/files/test_id", "Get file metadata",
                 skip_reason="Requires actual file ID")
    test_endpoint("GET", "/api/v1/files/test_id/download", "Download file",
                 skip_reason="Requires actual file ID")
    test_endpoint("DELETE", "/api/v1/files/test_id", "Delete file",
                 skip_reason="Requires actual file ID")
...
def test_generator_endpoints():
    ...
    test_endpoint("GET", "/api/v1/generators/apisix/models", "Get APISIX models",
                 skip_reason="Requires provider parameter")
    
    # Test parameter endpoint for specific generator type  
    test_endpoint("GET", "/api/v1/generators/params/AI%20Gateway", 
                 "Get generator params", skip_reason="URL encoding issue with space in type name")
    ...
    gen_created = test_endpoint("POST", "/api/v1/generators", "Create generator", 
                               generator_payload)
    
    # If generator created, test other operations
    if gen_created:
        test_endpoint("POST", "/api/v1/generators/test_gen_id/test", "Test generator",
                     skip_reason="Requires actual generator ID and working AI service")
        test_endpoint("PUT", "/api/v1/generators/test_gen_id", "Update generator",
                     skip_reason="Requires actual generator ID")
        test_endpoint("DELETE", "/api/v1/generators/test_gen_id", "Delete generator",
                     skip_reason="Requires actual generator ID")
...
def test_dataset_endpoints():
    ...
    test_endpoint("POST", "/api/v1/datasets/preview", "Preview dataset", 
    ...
    # Test field mapping
    test_endpoint("POST", "/api/v1/datasets/field-mapping", "Get field mapping",
                 {"file_content": "dGVzdCBjc3YgZGF0YQ==", "file_type": "csv"})
    
    # Skip operations requiring actual dataset IDs
    test_endpoint("GET", "/api/v1/datasets/test_id", "Get dataset details",
                 skip_reason="Requires actual dataset ID")
    test_endpoint("POST", "/api/v1/datasets/test_id/test", "Test dataset",
                 skip_reason="Requires actual dataset and generator IDs")
    test_endpoint("POST", "/api/v1/datasets/test_id/save", "Save dataset",
                 skip_reason="Requires actual dataset ID")
    test_endpoint("POST", "/api/v1/datasets/test_id/transform", "Transform dataset",
                 skip_reason="Requires actual dataset ID")
    test_endpoint("PUT", "/api/v1/datasets/test_id", "Update dataset",
                 skip_reason="Requires actual dataset ID")
    test_endpoint("DELETE", "/api/v1/datasets/test_id", "Delete dataset",
                 skip_reason="Requires actual dataset ID")
...
def test_converter_endpoints():
    ...
    converter_created = test_endpoint("POST", "/api/v1/converters", "Create converter", 
                                    converter_payload)
    
    # Skip operations requiring actual converter IDs
    test_endpoint("GET", "/api/v1/converters/test_id", "Get converter details",
                 skip_reason="Requires actual converter ID")
    test_endpoint("POST", "/api/v1/converters/test_id/preview", "Preview converter",
                 skip_reason="Requires actual converter ID")
    test_endpoint("POST", "/api/v1/converters/test_id/apply", "Apply converter",
                 skip_reason="Requires actual converter and dataset IDs")
    test_endpoint("POST", "/api/v1/converters/test_id/test", "Test converter",
                 skip_reason="Requires actual converter and dataset IDs")
    test_endpoint("PUT", "/api/v1/converters/test_id", "Update converter",
                 skip_reason="Requires actual converter ID")
    test_endpoint("DELETE", "/api/v1/converters/test_id", "Delete converter",
                 skip_reason="Requires actual converter ID")
...
def test_scorer_endpoints():
    ...
    test_endpoint("POST", "/api/v1/scorers/test_id/test", "Test scorer",
                 skip_reason="Requires actual scorer ID")
    test_endpoint("POST", "/api/v1/scorers/test_id/clone", "Clone scorer",
                 skip_reason="Requires actual scorer ID")
    test_endpoint("PUT", "/api/v1/scorers/test_id", "Update scorer",
                 skip_reason="Requires actual scorer ID")
    test_endpoint("DELETE", "/api/v1/scorers/test_id", "Delete scorer",
                 skip_reason="Requires actual scorer ID")
...
def print_summary():
    ...
    success_rate = (test_results['passed'] / (test_results['total'] - test_results['skipped'])) * 100 if test_results['total'] > test_results['skipped'] else 0
