...
def upgrade():
    ...
    op.create_table('cob_template_versions',
    ...
    op.add_column('cob_schedules',
        sa.Column('data_selection', sa.JSON(), nullable=True, server_default='{}')
    )
    op.add_column('cob_schedules',
    ...
    op.create_table('cob_scan_data_cache',
        sa.Column('id', sa.String(), primary_key=True),
    ...
    op.create_table('cob_report_variables',
        sa.Column('id', sa.String(), primary_key=True),
    ...
    op.create_table('cob_block_definitions',
        sa.Column('id', sa.String(), primary_key=True),
    ...
    op.bulk_insert(
        sa.table('cob_block_definitions',
        ...
        [
            ...
            },
            {
                ...
                'default_config': json.dumps({
                    "visualizations": ["Metric Cards", "Risk Heatmap"],
                    "metric_source": "Combined"
                })
            },
            {
                'id': 'blk_toxicity_heatmap',
