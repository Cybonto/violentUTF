...
class ScorerCreateRequest(BaseModel):
    ...
    @classmethod
    def validate_name_field(cls: Type["ScorerCreateRequest"], v: str) -> str:
    ...
    @classmethod
    def validate_scorer_type_field(cls: Type["ScorerCreateRequest"], v: str) -> str:
    ...
    @classmethod
    def validate_parameters_field(cls: Type["ScorerCreateRequest"], v: dict) -> Dict[str, object]:
        """Validate scorer parameters."""
        return validate_generator_parameters(v)

    @field_validator("generator_id")
    @classmethod
    def validate_generator_id_field(cls: Type["ScorerCreateRequest"], v: str) -> str:
...
class ScorerCloneRequest(BaseModel):
    ...
    @classmethod
    def validate_new_name_field(cls: Type["ScorerCloneRequest"], v: str) -> str:
...
class ScorerUpdateRequest(BaseModel):
    ...
    @field_validator("name")
    @classmethod
    def validate_name_field(cls: Type["ScorerUpdateRequest"], v: str) -> str:
        """Validate scorer name."""
        if v is not None:
    ...
    @field_validator("parameters")
    @classmethod
    def validate_parameters_field(cls: Type["ScorerUpdateRequest"], v: Optional[dict]) -> Optional[Any]:
        """Validate scorer parameters."""
        if v is not None:
            return validate_generator_parameters(v)
        return v
...
class ScorerValidationRequest(BaseModel):
    ...
    @field_validator("scorer_type")
    @classmethod
    def validate_scorer_type_field(cls: Type["ScorerValidationRequest"], v: str) -> str:
        """Validate scorer type."""
        v = sanitize_string(v)
    ...
    @field_validator("parameters")
    @classmethod
    def validate_parameters_field(cls: Type["ScorerValidationRequest"], v: dict) -> Dict[str, object]:
        """Validate scorer parameters."""
        return validate_generator_parameters(v)

    @field_validator("generator_id")
    @classmethod
    def validate_generator_id_field(cls: Type["ScorerValidationRequest"], v: str) -> str:
        """Validate generator ID."""
        if v is not None:
...
class ScorerAnalyticsRequest(BaseModel):
    ...
    @classmethod
    def validate_scorer_id_field(cls: Type["ScorerAnalyticsRequest"], v: str) -> str:
        """Validate scorer ID."""
        v = sanitize_string(v)
...
class ScorerConfigImport(BaseModel):
    ...
    scorers: List[Dict[str, Any]] = Field(
        ...
        description="Scorer configurations to import",
        max_length=50,
    )
    ...
    @classmethod
    def validate_scorers_field(cls: Type["ScorerConfigImport"], v: List[dict]) -> List[Dict[str, Any]]:
