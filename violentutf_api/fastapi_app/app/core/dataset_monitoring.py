...
class PerformanceMonitor:
    ...
    def get_performance_summary(self, operation_type: Optional[str] = None) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_count": self.error_counts.get(f"{operation_type}_error", 0) if operation_type else sum(self.error_counts.values())
        }
    ...
    def get_detailed_metrics(self) -> Dict[str, Any]:
        ...
        return {
            "performance_summary": {
                op_type: self.get_performance_summary(op_type)
                for op_type in self.operation_timings.keys()
            },
