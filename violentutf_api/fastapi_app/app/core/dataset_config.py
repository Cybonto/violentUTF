...
def validate_dataset_config(dataset_type: str, config: Dict[str, Any]) -> None:
    ...
    dataset_requirements = {
        "harmbench": {
            "optional": ["source", "source_type", "cache", "data_home"]
        },
        "many_shot_jailbreaking": {
            "optional": []
        },
        "decoding_trust_stereotypes": {
            "optional": ["source", "source_type", "cache", "data_home", "stereotype_topics", "target_groups", "system_prompt_type"]
        },
        "seclists_bias_testing": {
            "optional": ["source", "source_type", "cache", "data_home", "random_seed", "country", "region", "nationality", "gender", "skin_color"]
        },
        "wmdp": {
            "optional": ["source", "source_type", "cache", "data_home", "categories"]
        },
        "adv_bench": {
            "optional": ["source", "source_type", "cache", "data_home"]
        },
        "aya_redteaming": {
            "optional": ["source", "source_type", "cache", "data_home", "languages"]
        },
        "forbidden_questions": {
            "optional": ["source", "source_type", "cache", "data_home"]
        },
        "pku_safe_rlhf": {
            "optional": ["source", "source_type", "cache", "data_home", "split"]
        },
        "xstest": {
            "optional": ["source", "source_type", "cache", "data_home"]
        }
    ...
    for param, value in config.items():
        ...
        elif param in ["source", "source_type", "data_home", "country", "region", "nationality", "gender", "skin_color", "split"]:
