...
class DocumentMetadata:
    ...
    def _extract_tags(self, content: str) -> List[str]:
        ...
        common_terms = [
            'api', 'apisix', 'authentication', 'docker', 'keycloak', 'mcp',
            'pyrit', 'garak', 'setup', 'configuration', 'troubleshooting',
            'testing', 'security', 'oauth', 'jwt', 'streamlit', 'fastapi'
        ]
...
class DocumentIndex:
    ...
    def search(self, query: str, category: Optional[str] = None, 
               tags: Optional[List[str]] = None, limit: int = 10) -> List[Tuple[str, float]]:
...
class DocumentationResourceProvider(BaseResourceProvider):
    ...
    def __init__(self):
        super().__init__(
            uri_pattern="violentutf://docs/{category}/{document_id}",
            provider_name="DocumentationProvider"
        )
    ...
    def _get_search_suggestions(self, query: str) -> List[str]:
        ...
        common_topics = [
            ...
            "API", "authentication", "Docker", "Keycloak", "MCP"
        ]
    ...
    async def _handle_document_request(self, category: str, document_id: str, params: Dict[str, Any]) -> Optional[AdvancedResource]:
        """Handle specific document requests"""
